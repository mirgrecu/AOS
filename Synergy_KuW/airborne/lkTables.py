...
#ds.to_netcdf('scattTablesW.nc',encoding={'zKaS':{'zlib':True,'complevel':9},\
#                                            'zWS':{'zlib':True,'complevel':9},\
#                                            'attKaS':{'zlib':True,'complevel':9},\
#                                            'attWS':{'zlib':True,'complevel':9},\
#                                            'zKaR':{'zlib':True,'complevel':9},\
#                                            'zWR':{'zlib':True,'complevel':9},\
#                                            'attKaR':{'zlib':True,'complevel':9},\
#                                            'attWR':{'zlib':True,'complevel':9}})
class scattTables:
    ...
    with Dataset('scattTablesW.nc') as fw:
        zWR=fw["zWR"][:]
        attWR=fw["attWR"][:]
        zWS=fw["zWS"][:]
        attWS=fw["attWS"][:]
